...
<iDOCTYPE html>
    ...
    <body>
        ...
        <div id="divDiscount" class="container">
            ...
            <div><select name="" id="selOKCASHBAG"></select>
            </div>
            <div><select name="" id="selCOUPONS"></select>
            </div>
        </div>
            ...
            */
            ...
            function changeLineSum(e, price) {
                ...
                let lineSum =
                    ...
                    e.target.parentNode.parentNode.getElementByClassName("line-sum")[0];
                ...
                for (let menu of menus) {
                    h.push(
                        `<button class="menu" onclick="selectFood(${menu.
                            menuId});">${menu.menuName}(${menu.price})</button>`
                    );
                }
